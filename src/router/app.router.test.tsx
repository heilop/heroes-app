...
vi.mock(('@/heroes/pages/hero/pages/HeroPage'), () => ({
  HeroPage: () => {
...
describe('appRouter', () => {
  ...
  test('should be confiured as expected', () => {
  ...
  test('should render the hero page at /heroes/:idSlug path', () => {
    const router = createMemoryRouter(appRouter.routes, {
  ...
  test('should redirecto to home page for unknonw routes', () => {
    const router = createMemoryRouter(appRouter.routes, {
